...
export default function ButtonGradient() {
  return (
    <div className="group relative">
      ...
      <button className="relative flex items-center divide-x divide-slate-500/75 rounded-lg border border-transparent bg-zinc-900/90 px-7 py-4 leading-none transition-colors duration-1000 hover:border hover:border-zinc-200/30795000 hover:bg-black/80">
